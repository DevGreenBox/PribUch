...
Нам нужно создать сайт для магазина где продаются приборы учета воды и тепловой энергии, название магазина: "ЭВР"
ценовой сегмент: Эконом, Средний, B2B-опт
Сколько примерно товаров будет на сайте: 50–500
Какие функции должны быть на сайте: Корзина, Оформление заказа, Фильтры в каталоге, Поиск по сайту, Автоматическое создание накладной, Цена доставки считается автоматически
Какие интеграции нужны: СДЭК PAY, Уведомления на почту
Фирменного стиля: нет
Стилистика сайта должна быть: Строгий минимализм
Цвета: базовые (черный, белый, серый) для акцента можно использовать красный или синий
Примеры сайтов (референсов), которые нравятся: 
https://www.elta-tsp.com
https://kupi-kip.ru/ 
по оформлению мне больше нравится сайт kupi-kip.ru, мне нравится сетка по которой расположены блоки и отступы, использование иконок, общий дизайн сайта, шрифты
название сайта это аббревиатура, создай временный логотип для сайта с названием "ЭВР" и фирменным знаком, примерно как в первом референсе (сайт www.elta-tsp.com)

сайт должен быть написан на языках: HTML, CSS, JavaScript
